    ...
    <% List<ProductoPedidoDetalle> productos = detalle.getProductos(); %>
                <div class="encabezadoFactura">
                    <div class="datosFactura">
                        ...
                        <p>TOPE S.L.</p>
                        <p>C/ Julián Camrillo nºX, Madrid</p>
   ...
   <section class="bg-blue">
            ...
            <% ProductoPedidoDetalle p = productos.get(i); %>
                <tr class="tamNombre">
                    <td><%= p.getUds() %></td>
                    <td>
                    <!--  <img src="<%= request.getContextPath() %>/imagenes/savethegreen/productos/<%= p.getImagen() %>" width="120" height="120" style="border-radius: 5%"> <!--saca atributo imagen del producto. Usa la ruta a partir de WebContent,que es donde nos localizamos aqui.-->
