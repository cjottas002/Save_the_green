    ...
    <head>
        ...
        <script>
            ...
            function confirmacion3(){
        		...
        		confirm("¿Seguro que deseas realizar el cambio?");
          ...
          <div class="request-a-callback-form" style="margin-left: 25%">
           <% Usuario u = (Usuario) request.getAttribute("usuario"); %>
              <form action="<%= request.getContextPath() %>/usuario"  method="get" name="registro" id="registro">
                   ...
                   <br>
                   <button data-text="Modificar" class="btn btn-primary" onclick="confirmacion3()">Modificar</button>
                </form>
            </div> 
                        ...
                        <div class="col-md-6">
                            <div class="usefull-links-widget clearfix">
                                <h4>Links usados</h4>
                                    ...
                                    <li><a href="formularioContactoIniciados.jsp">Contacta</a></li>
                                </ul>
