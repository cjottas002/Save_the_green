       ...
       <form action="UsuarioFormularioServlet" method="get" name="mensaje" id="mensaje">
        ...
        <div class="request-a-callback clearfix animate fadeInUp">
            ...
            <div class="request-a-callback-form">
                <form action="<%= request.getContextPath() %>/usuario"  method="get" name="registro" id="registro">
                    ...
                    <input type="number" min="16" max="105" name="edad" id="edad" class="izquierda" placeholder="Edad">
