        ...
        <header id="header">
            ...
            <!-- INFORMACIÓN DE ARRIBA, BARRA AZUL -->
             <div class="top-bar clearfix">
                ...
                <ul class="icono">
                    <li><img src="imagenes/savethegreen/icono-telefono.jfif" width="25px" height="25px" style="border-radius: 50%;"> Tlf. 971 29 17 56</li>
                    <li><img src="imagenes/savethegreen/ubicacion2.png" width="25px" height="25px" style="border-radius: 50%;"> C/Julián Camarillo, Madrid</li>
                </ul>
            </div>
...
<br><br>
                   ...
                   <p> La ciudadanía ha sido la primera en actuar. Habitantes de más de 150 países participan en actividades de limpieza de playas, bosques, calles ... en una iniciativa que ha derivado en Día Mundial: el Día Mundial de la Limpieza (World Cleanup Day), considerado la mayor acción cívica del mundo. <img src="imagenes/savethegreen/campo3.jpeg" style="float: right; margin: 2%;">
                    ...
                    No solo son hermosas las plantas como ornamentos caseros, también utilizan dióxido de carbono y liberan oxígeno a la atmósfera. Cultiva ya mismo árboles y flores en el jardín y los patios de tu hogar. Es una actividad sencilla, que reporta grandes beneficios al planeta.</p>
